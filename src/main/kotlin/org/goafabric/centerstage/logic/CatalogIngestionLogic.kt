...
import org.goafabric.centerstage.adapter.GitHubService
import org.goafabric.centerstage.adapter.GitLabService
...
class CatalogIngestionLogic(
    ...
    private fun toDocEo(doc: org.goafabric.centerstage.controller.dto.TechDoc, componentName: String) =
        DocEo().apply {
            id                    = UUID.randomUUID().toString()
